// ============================================================
// HN MUEBLES - SCRIPT PRINCIPAL (ESTILO EXCEL PROFESIONAL)
// ============================================================
...
async function exportarIngresosPDF() {
  ...
  // Fila de Totales Exacta tipo Excel al final de la tabla
  filas.push([
    "TOTALES",
    "",
    "",
  ...
  if (typeof doc.autoTable === "function") {
    doc.autoTable({
      ...
      didParseCell: function(data) {
        // Estilo especial para resaltar la última fila de Totales estilo Excel clásico
